...
print_R($status);
  ...
  public function gitAuthenticate() {
...
//    echo "</pre>";
  ...
  public function gitDeleteAccessToken() {
    $ch = curl_init('https://api.github.com/access_token');
    $curl_opt = array(
        CURLOPT_SSL_VERIFYPEER => true,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_USERAGENT => 'manufakturGitDownloads',
