...
$check = array(
    'libMarkdown' => array(
        'directory' => 'lib_markdown',
        'version' => '0.12',
        'problem' => 'libMarkdown => <b><a href="https://addons.phpmanufaktur.de/download.php?file=libMarkdown" target="_blank">Download actual version</a></b>'
        ),
    );
